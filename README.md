...
- [park_et_al_CM/](https://github.com/ytabatabaee/ensemble-clustering-data/tree/main/park_et_al_CM): 27 synthetic LFR graphs from [Park et. al. (2024)](https://link.springer.com/chapter/10.1007/978-3-031-53499-7_1), that were generated based on the properties of a collection of real networks and their Leiden clusterings with different resolutions. The subdirectories are named as `[network-name]_[resolution]_lfr` with the resolution field varyhing between `modularity` or `0.5` to `0.0001` (for Leiden-CPM).  
- [real_networks/](https://github.com/ytabatabaee/ensemble-clustering-data/tree/main/real_networks): Real networks, including a network of Amazon Products ([amazon/](https://github.com/ytabatabaee/ensemble-clustering-data/tree/main/real_networks/amazon)) and the DBLP collaboration network ([DBLP/](https://github.com/ytabatabaee/ensemble-clustering-data/tree/main/real_networks/DBLP))
